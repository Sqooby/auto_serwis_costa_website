...
export const metadata: Metadata = {
  ...
  description: 'Profesjonalny serwis samochodowy i klimatyzacji w Rzeszowie. Uczciwe ceny, fachowa diagnoza, 55 opinii 4.8/5 ★. Zadzwoń: 880 378 675.',
  keywords: 'mechanik Rzeszów, serwis klimatyzacji Rzeszów, naprawa samochodów Rzeszów, auto serwis Rzeszów, diagnostyka komputerowa',
