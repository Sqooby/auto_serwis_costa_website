      ...
      <div className="container-custom mx-auto px-4 py-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-heading font-bold leading-tight">AUTO SERVICE</span>
                <span className="text-sm font-heading font-semibold text-costa-blue">COSTA</span>
              </div>
            </div>

            <p className="text-white/70 leading-relaxed">
              Zaufany serwis samochodowy w Rzeszowie. Fachowa diagnostyka, uczciwe ceny i perfekcyjna obsługa.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { href: '/uslugi#klimatyzacja', label: 'Serwis Klimatyzacji', icon: '❄️' },
                { href: '/uslugi#mechanika', label: 'Naprawy Mechaniczne', icon: '🔧' },
                { href: '/uslugi#diagnostyka', label: 'Diagnostyka Komputerowa', icon: '💻' },
                ...
                <li key={service.href}>
                  ...
                  >
                    <span className="transform group-hover:scale-110 transition-transform">{service.icon}</span>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-white/70 text-sm">Sobota - Niedziela</span>
                </div>
              ...
              <li>
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-costa-blue/20 flex items-center justify-center group-hover:bg-costa-blue/30 transition-colors flex-shrink-0">
                    <svg className="w-5 h-5 text-costa-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <div className="flex items-start gap-3 text-white/70">
                  <div className="w-10 h-10 rounded-lg bg-costa-turquoise/20 flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-costa-turquoise" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/60">
          <p className="text-center md:text-left">
            © {currentYear} <span className="text-white font-heading font-semibold">AUTO SERVICE COSTA</span> - Damian Paśko. Wszelkie prawa zastrzeżone.
          </p>

          <div className="flex flex-wrap justify-center gap-6">
            <Link href="/polityka-prywatnosci" className="hover:text-costa-blue transition-colors">
              Polityka Prywatności
            </Link>
            <Link href="/regulamin" className="hover:text-costa-blue transition-colors">
              Regulamin
            </Link>
            <Link href="/cookies" className="hover:text-costa-blue transition-colors">
              Cookies
            </Link>
          </div>
        </div>
